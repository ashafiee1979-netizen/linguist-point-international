    ...
    <div className={`pt-2 border-t border-slate-100 flex flex-col items-center gap-1.5 ${className}`}>
      <div className="flex items-center gap-1.5 text-[11px] font-semibold text-slate-500">
        ...
        <span className="inline-flex items-center gap-1 font-bold text-slate-700">
          Powered by
          <svg className="h-3.5 w-auto text-[#635BFF]" viewBox="0 0 60 25" fill="currentColor" aria-label="Stripe">
      ...
      <div className="flex items-center justify-center gap-1.5 sm:gap-2 flex-wrap" aria-label="Accepted payment methods">
        {/* Visa */}
        <div className="h-6 w-10 sm:w-11 rounded border border-slate-200 bg-white shadow-2xs flex items-center justify-center p-1" title="Visa">
          <svg className="h-3 sm:h-3.5 w-auto" viewBox="0 0 48 16" fill="none">
            <path
        ...
        {/* Mastercard */}
        <div className="h-6 w-10 sm:w-11 rounded border border-slate-200 bg-white shadow-2xs flex items-center justify-center p-1" title="Mastercard">
          <svg className="h-3.5 sm:h-4 w-auto" viewBox="0 0 32 20" fill="none">
        ...
        {/* PayPal */}
        <div className="h-6 w-10 sm:w-11 rounded border border-slate-200 bg-white shadow-2xs flex items-center justify-center p-1" title="PayPal">
          <svg className="h-3.5 sm:h-4 w-auto" viewBox="0 0 32 24" fill="none">
            <path
        ...
        {/* Apple Pay */}
        <div className="h-6 w-10 sm:w-11 rounded border border-slate-200 bg-white shadow-2xs flex items-center justify-center p-0.5" title="Apple Pay">
          <svg className="h-3.5 sm:h-4 w-auto" viewBox="0 0 50 20" fill="currentColor">
            {/* Apple logo */}
        ...
        {/* Stripe Badge */}
        <div className="h-6 w-10 sm:w-11 rounded border border-slate-200 bg-white shadow-2xs flex items-center justify-center p-1" title="Stripe Secure Gateway">
          <svg className="h-3 sm:h-3.5 w-auto text-[#635BFF]" viewBox="0 0 60 25" fill="currentColor">
            <path d="M59.64 14.28c0-4.48-2.18-7.98-6.42-7.98-4.26 0-6.85 3.5-6.85 7.94 0 5.27 3.09 7.9 7.42 7.9 2.1 0 3.7-.48 4.9-1.18v-3.32c-1.2.62-2.58.94-4.14.94-1.7 0-3.18-.62-3.38-2.4h8.4c.04-.3.07-.66.07-.88zm-8.4-1.6c0-1.62.98-2.3 2.06-2.3 1.06 0 1.98.68 1.98 2.3h-4.04zm-8.1-6.38c-1.42 0-2.38.68-2.88 1.18l-.2-1h-4.34v19.46l4.68-.98.02-4.72c.5.42 1.34 1 2.66 1 2.8 0 5.6-2.28 5.6-7.44-.02-4.9-2.76-7.5-5.54-7.5zm-1.28 10.96c-.92 0-1.52-.36-1.92-.78l-.02-5.46c.42-.46 1.04-.8 1.94-.8 1.5 0 2.5 1.44 2.5 3.54 0 2.06-.98 3.5-2.5 3.5zm-12.78-8.24h-4.66v12.76h4.66V9.02zm0-2.62h-4.66v-3.7l4.66-.98v4.68zm-7.66 4.74c-.58-.3-1.6-.62-2.7-.62-1.92 0-3.16 1-3.16 2.7 0 3.06 4.22 2.56 4.22 5.24 0 .9-.74 1.44-1.84 1.44-1.32 0-2.72-.56-3.7-1.18l-.82 3.32c1.08.56 2.72.9 4.34.9 2.8 0 4.78-1.38 4.78-3.26 0-3.3-4.24-2.72-4.24-5.26 0-.74.62-1.24 1.62-1.24.98 0 2.22.38 3.08.84l.42-2.88z" />
          </svg>
        </div>
      </div>
